...
async function seed() {
  ...
  // Seed gallery items
  const galleryItems = [
    { title: 'Hình ảnh phối cảnh', date: '20.10.2026', thumbnail: '/infi-pool.webp', category: 'image', url: '', images: ['/infi-pool.webp'], sort_order: 1 },
    { title: 'Video cảnh quan tiện ích', date: '20.10.2026', thumbnail: '/scenery.jpg', category: 'video', url: 'https://www.youtube.com/watch?v=dQw4w9WgXcQ', images: null, sort_order: 2 },
    { title: 'Hình lifestyle', date: '20.10.2026', thumbnail: '/village.webp', category: 'image', url: '', images: ['/village.webp'], sort_order: 3 },
    { title: 'Tải về Leaflet Balanca 2026', date: '20.10.2026', thumbnail: '/pool-view.jpg', category: 'document', url: '#', images: null, sort_order: 4 },
    { title: 'Tải về Tài liệu bán hàng', date: '20.10.2026', thumbnail: '/co-working.webp', category: 'document', url: '#', images: null, sort_order: 5 },
    { title: 'Hình ảnh công viên ven sông', date: '15.10.2026', thumbnail: '/wellness-park.jpg', category: 'image', url: '', images: ['/wellness-park.jpg'], sort_order: 6 },
    { title: 'Video giới thiệu tiện ích nội khu', date: '12.10.2026', thumbnail: '/coffee-shop.webp', category: 'video', url: '#', images: null, sort_order: 7 },
    { title: 'Hình ảnh trung tâm thương mại', date: '08.10.2026', thumbnail: '/mall.webp', category: 'image', url: '', images: ['/mall.webp'], sort_order: 8 },
    { title: 'Hình ảnh hệ thống giáo dục', date: '05.10.2026', thumbnail: '/school.webp', category: 'image', url: '', images: ['/school.webp'], sort_order: 9 },
    { title: 'Video TVC dự án Casamia Balanca', date: '01.10.2026', thumbnail: '/hotel.webp', category: 'video', url: '#', images: null, sort_order: 10 },
    { title: 'Tải về Mặt bằng tổng thể dự án', date: '28.09.2026', thumbnail: '/map-balanca.webp', category: 'document', url: '#', images: null, sort_order: 11 },
    { title: 'Hình ảnh rừng dừa Bảy Mẫu', date: '25.09.2026', thumbnail: '/river.jpg', category: 'image', url: '', images: ['/river.jpg'], sort_order: 12 },
    { title: 'Hình ảnh nhà phố thương mại', date: '22.09.2026', thumbnail: '/center-square.jpg', category: 'image', url: '', images: ['/center-square.jpg'], sort_order: 13 },
    { title: 'Video flycam toàn cảnh dự án', date: '18.09.2026', thumbnail: '/exterior-2.jpg', category: 'video', url: '#', images: null, sort_order: 14 },
    { title: 'Tải về Bảng giá tham khảo', date: '15.09.2026', thumbnail: '/bar.webp', category: 'document', url: '#', images: null, sort_order: 15 },
  ]
  ...
  for (const item of galleryItems) {
    await connection.query(
      ...
      [item.title, item.date, item.thumbnail, item.category, item.url, item.images ? JSON.stringify(item.images) : null, item.sort_order]
    )
  }
